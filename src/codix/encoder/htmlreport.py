"""
Templates for the html report generated by new code
"""
...
def to_html_report(specs):
    """
    Functions that takes the code specifications en returns the filled
    template.
    """
    ...
    if specs['period'] is None:
        ...
        timing += f"<p><strong>Interval: </strong> {specs['period']:5.3} seconds</p>"
